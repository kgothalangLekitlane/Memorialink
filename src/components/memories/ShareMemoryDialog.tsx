...
export function ShareMemoryDialog({ memoryId }: ShareMemoryDialogProps) {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="font-headline">Share Memory</DialogTitle>
          <DialogDescription>
            Anyone with this link will be able to view this memory.
          </DialogDescription>
        </DialogHeader>
